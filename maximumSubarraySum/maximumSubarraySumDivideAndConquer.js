 ...
 *
 * Можна помітити що рішення нижче дуже нагадує mergeSort в тому плані, що розбиває масиви на дві частини,
 * а потім збирає докупи. І що цікаво так само як і з mergeSort на маленьких масивах краще буде працювати лінійний перебір.
 * Для якої саме довжини - це треба тестувати, це наскільки я розумію залежить від процесору. Але можна гратися приблизно
 * в діапазоні від 4 до 64 напевно
 */
