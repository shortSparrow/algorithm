...
# 
# X_train - має ту саму форму що і digits.data, просто має меншу довжину масиву за X_train на 80% 
# X_test - той самий формат що і у X_train. Це дані для тестування (20% від digits.data)
# 
# y_train - те саме що і X_train, тільки для digits.target
# y_test - те саме що і X_test, тільки для digits.target
...
# Створюємо екземпляр класифікатора KNN.
# K=3 означає, що ми будемо шукати 3 найближчих сусідів.
# Ти можеш поекспериментувати з різними значеннями K!
k_value = 3 
knn = KNeighborsClassifier(n_neighbors=k_value)

# Навчаємо модель, використовуючи навчальні дані (зображення та їхні мітки)
knn.fit(X_train, y_train)

# Робимо прогнози на тестових даних
# y_pred - [4,1,6,0,3,5,...] - це одномірний масив чисел які є передбаченням того, які
# цифри мають бути у X_test. Відповідно довжина цього масиву дорівнює довжині X_test
