 ...
 * 
 * 
 * Оскільки в найгіршому випадку складність O^2 то виникає питання, а чи не можна використати
 * бінарний пошук щоб другий цикл і отримати O(n * log n) - НІ. Оскільки після вираховування індексу
 * за O(log n) нам все одно доведеться змістити елементи (shift). 
 * 
 */
